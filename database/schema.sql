...
CREATE TABLE settings (
    ...
    schedule INTEGER DEFAULT 300,             -- Joke-sending interval in seconds
...
INSERT INTO reactions (id, name) VALUES (0, 'thinking', '🤔');  
INSERT INTO reactions (id, name) VALUES (-1, 'dislike','👎');
