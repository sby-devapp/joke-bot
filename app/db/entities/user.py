...
class User:
    ...
    def is_exists(self) -> bool:
        ...
        try:
            ...
            logger.info(f"Checked existence of user with ID {self.id}: {'Exists' if exists else 'Does not exist'}")
            return exists
        except Exception as e:
    ...
    def react_to_joke(self, joke_id: int, reaction_id: int):
        ...
        try:
            ...
            logger.error(f"Failed to process reaction for user_id={self.id}, joke_id={joke_id}: {e}")
            raise
